...
?>
                            <p class="text-center h5 fw-bold mb-5 mx-1 mx-md-4 mt-4">Edit Account</p>
                                    <form class="mx-1 mx-md-4" action="edit.customer.data.php" method="post">
                                        <input type="hidden" name="customer_id" value="<?php echo $h; ?>">
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <a button href="customer.form.php" class="btn btn-outline-success">Cancel</a>
                                    </div>
