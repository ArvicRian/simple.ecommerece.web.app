...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
            ...
            if(!$result->num_rows > 0){
                $sql = "INSERT INTO customer (fname, lname, address, contact, username, password)
					VALUES ('$fname','$lname','$address','$contact','$username','$password')";
			    $result = mysqli_query($con, $sql);
...
?>
                            <p class="text-center h5 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add new customer</p>
...
<div class="d-flex flex-row align-items-center mb-4">
    <div class="form-outline flex-fill mb-0">
        <input type="text" id="form3Example4c" name="address"
            class="form-control" placeholder="Santa Barbara Area Only"
...
<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
    <button type="submit" name="submit"
        ...
        &nbsp;&nbsp;&nbsp;
        <a button href="customer.form.php"
