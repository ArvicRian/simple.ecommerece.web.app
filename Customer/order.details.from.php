                        ...
                        <nav class="navbar navbar-expand-sm navbar-light">
                            <div class="container-fluid">
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand mb-0 h6" href="order.details.from.php"><small><mark>Accepted</mark></small></a>
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card border-top border-bottom border-3"
                                            ...
                                            <div class="card-body p-5">
                                                ...
                                                <p class="lead fw-bold mb-5" style="color: #f37a27;">Cash on Delivery
                                                    Reciept</p>
    ...
    if (!$i == 0){
        ...
        if ($result){
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo'<script> location.replace("order.pending.form.php"); </script>';
...
?>
                                                        ...
                                                        <div class="border border-secondary"></div>
                                                            <p>Total amount Payable ₱<?php echo $totalSum ?></p>
                                                        </div>

                                                    </div>
                                                    <div class="row">
                                                    
                                                    <p>Delivery Time: <?php echo $f ?></p>
                                                        <p class="small text-muted mb-1">Contact details</p>
                                                        <p class="small text-muted mb-1">Name: <?php echo $a ?>&nbsp;
                                                            <?php echo $b ?></p>
                                                        <p class="small text-muted mb-1">Address: <?php echo $c ?></p>
                                                        <p class="small text-muted mb-1">Contact number:
                                                            <?php echo $d ?></p>
                                                        <a href="order.receive.php?id= <?php echo $g ?>" button type="button" class="btn btn-info">Order Receive</a>
