                            ...
                            <div class="wrapper bg-white mt-sm-5">
                                <div class="py-2">
                                    ...
                                    <div class="row py-2">
                                        ...
                                        <div class="row py-2">
                                            <div class="col-md-6"> <label for="email">Address</label> <input
                                                    value="<?php echo $row['address']; ?>" class="bg-light form-control"
                                                    readonly> </div>
                                        ...
                                        <div class="py-3 pb-4 border-bottom"> <a button class="btn btn-success mr-3"
                                                href="update.form.php">Update Account</a>
                                        </div>
