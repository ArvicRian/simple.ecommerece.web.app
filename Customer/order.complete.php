                        ...
                        <nav class="navbar navbar-expand-sm navbar-light">
                            <div class="container-fluid">
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand mb-0 h6" href="order.complete.php"><small><mark>Completed</mark></small></a>
...
if ($result->num_rows > 0) {
    ...
    if (!$i == 0){
        $query = 'SELECT * FROM orders_history WHERE pstatus="Receive" AND customer_id ="'.$v1.'"';
