                        ...
                        <nav class="navbar navbar-expand-sm navbar-light">
                            <div class="container-fluid">
                                <div class="navbar-header">
                                    <a class="navbar-brand mb-0 h6" href="order.form.php"><small>Pending</small></a>
                                    <a class="navbar-brand mb-0 h6" href="order.form1.php"><small>Accepted</small></a>
                                    <a class="navbar-brand mb-0 h6" href="order.form2.php"><small><mark>Cancelled</mark></small></a>
                                </div>
                            </div>
                        </nav>
                        <br>
...
if ($result->num_rows > 0) {
    ...
    if (!$i == 0){
        $query = 'SELECT * FROM orders_history WHERE pstatus="Cancel" AND seller_id ="'.$v1.'"';
